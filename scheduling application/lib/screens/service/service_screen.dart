...
final Function(String) markNotificationAsRead; 
  // 💥 BỔ SUNG: Thêm callback addNotification
...
// 💥 Card hiển thị thông tin gói khám (ĐÃ CẬP NHẬT TRUYỀN addNotification)
...
addNotification: addNotification, // 💥 BỔ SUNG tham số bị thiếu
),
),
);
},
